...
<?php
    ...
    <section id="scholarship2">
        <img class="scholar" src="images/webdevelop.jpg" alt="Scholarshipportal"><br><br>
        <div class="box4">
            <h2 style="color:black;margin:0;">Web Development Internship in Mumbai at Apex Group Of Companies</h2><br>
            <h5 style="color:black">About Apex Group</h5><br>
            <p>
                Apex Group of Companies is an end-to-end blue-collar workforce solutions provider, from hiring to redeployment. It additionally provides infrastructure development support to the construction and engineering companies, as well as security services to commercial and residential properties.
            </p>
            <h5 style="color: blue;">About The Internship</h5>
            <ul>
                <li>Job Responsibilities</li>
                <li>Build and improve the existing Website basis the brief given.</li>
                <li>Must have a knack for design elements and plugin usage on Wordpress .</li>
                ...
                <li>Stay plugged into emerging technologies/industry website trends and apply them into operations and activities</li>
                <li>Coordinate with Marcom to match visual design intent</li>
            </ul>
            ...
            <ul>
                ...
                <li>can start the internship between 26th Sep'22 and 31st Oct'22</li>
                <li>are available for duration of 6 months</li>
                <li>are from or open to relocate to Mumbai and neighboring cities</li>
                <li>have relevant skills and interests</li>
            </ul>
            <a class="btn btn-success" href="https://internshala.com/internship/detail/web-development-internship-in-mumbai-at-apex-group-of-companies1664192078" target="_blank">Apply Now</a>
        </div>
    </section>
</body>
</html>