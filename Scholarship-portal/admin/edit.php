...
<div class="wrapper">
		...
		if (isset($_SESSION['login_user']))
		{
			...
			<nav id="navbar">
				...
				<ul>
                    ...
                    <li class="item"><a href="#services">Student Services</a></li>
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admin SET pic='$pic', Firstname='$Firstname', Lastname='$Lastname', username='$username', password='$password', email='$email' WHERE username='".$_SESSION['login_user']."';";
