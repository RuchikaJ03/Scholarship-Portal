...
<body>
    <div id="mySidenav" class="sidenav">
      ...
      <a href="addinternship.php">Interships</a>
    ...
    <nav id="navbar">
        ...
        <ul>
          ...
          ?>
              ...
              <div class="container">
                  <h2 style="color:black; font-family:Times New Roman; text-align:center;">Add New Internship</h2><br>
                  <form class="book" action="" method="post">
                      <input type="text" name="Internship" placeholder="Internship Name" required=""><br><br>
                      <input type="text" name="Duration" placeholder="Duration" required=""><br><br>
                      <input type="text" name="Stipend" placeholder="Stipend" required=""><br><br>
              ...
              <?php
                if (isset($_POST['submit'])) 
                {
                  if (isset($_SESSION['login_user'])) 
                  {
                    ...
                    mysqli_query($db,"INSERT INTO `internship`(`Internship`, `Duration`, `Stipend`) VALUES ('$_POST[Internship]','$_POST[Duration]','$_POST[Stipend]');");
                    ?>
