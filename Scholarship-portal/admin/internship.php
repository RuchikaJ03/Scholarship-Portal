...
<?php
    ...
    <div class="container">
        <h4 style="color:Blue">Internship</h4><br><br>
        <section class="scholarship1">
            <div>
                <?php
                $res=mysqli_query($db,"SELECT * FROM `internship`;");
                    echo"<table>";
                        echo"<tr>";
                            echo"<th>";echo"Internship";echo"</th>";
                            echo"<th>";echo"Duration";echo"</th>";
                            echo"<th>";echo"Stipend";echo"</th>";
                            echo"<th>";echo"</th>";
                        echo"</tr>";
                        echo"<tr>";
                        ...
                        {
                            echo"<td>";echo $row['Internship'];echo"</td>";
                            echo"<td>";echo $row['Duration']; echo"</td>";
                            echo"<td>";echo $row['Stipend'];echo"</td>";
                            echo"<td>";echo'<a class="btn btn-success" href="'.$row['Link'].'" target="_blank">View Details</a>';echo"</td>";
                            ?>
                            <!-- <td><a class="btn btn-success" href="Colgate.php" target="_blank">View Details</a></td> -->
                            <?php
                        echo"</tr>";
                        echo"<tr>";
                        }
