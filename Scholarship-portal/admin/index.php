...
<body>
    <nav id="navbar">
        ...
        <ul>
            ...
            <li class="item"><a href="admin_login.php">Login</a></li>
    ...
    <div id="information">
        ...
        <div class="container">
            ...
            <ul>
                <li><a>Sign up with Email id</a></li>
                ...
                <!-- <li><a>Download Buddy4Study app to keep track of scholarships</a></li>           -->
            </ul>
            <br><br>
            ...
            <ul>
                ...
                <!-- <li><a>Apply for scholarships with easy to fill form - most of your information will be prefilled</a></li>
                <li><a>Upload high-quality documents with all fields visible</a></li>
                <li><a>Regularly monitor your email/mobile for Buddy4Study notifications</a></li>
                <li><a>Respond to questions in telephonic interviews</a></li> -->
            </ul>
            <br><br>
